...
class OrderSetData:
    ...
    data_set = [('top_button', 'ИмяОдин', 'ФамилияОдин', 'Адрес 1', 'Митино', '+79999999999',
                 int(datetime.now().strftime('%d')), 'двое суток', 'чёрный жемчуг',
                 'Комментарий курьеру'),
                ('down_button', 'ИмяДва', 'ФамилияДва', 'Адрес 2', 'Строгино', '+79888888888',
                 int(datetime.now().strftime('%d')), 'трое суток', 'серая безысходность',
                 'Комментарий курьеру 2')]
